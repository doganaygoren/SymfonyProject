 ...
 */
final class Version20200107001053 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message ADD status VARCHAR(15) DEFAULT NULL, ADD ip VARCHAR(50) DEFAULT NULL, ADD note VARCHAR(255) DEFAULT NULL, ADD created_at DATETIME DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, CHANGE name name VARCHAR(30) DEFAULT NULL, CHANGE email email VARCHAR(100) DEFAULT NULL, CHANGE subject subject VARCHAR(255) DEFAULT NULL');
